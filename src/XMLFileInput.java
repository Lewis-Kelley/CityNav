...
public class XMLFileInput {
	...
	public static void main(String[] args) throws Exception {
		...
		Node n1 = new Node("Connecticut Avenue", new Coordinate(17, 0), 10);
		Node n2 = new Node("Vermont Avenue", new Coordinate(24, -3), 4);
		Node n3 = new Node("Oriental Avenue", new Coordinate(50, 12), 3);
		Node n4 = new Node("Baltic Avenue", new Coordinate(77, -5), 7);
		Node n5 = new Node("Mediterranean Avenue", new Coordinate(89, 6), 0);
		Node n6 = new Node("St. Charles Place", new Coordinate(-5, 18), 7);
		Node n7 = new Node("States Avenue", new Coordinate(12, 35), 9);
		Node n8 = new Node("Virginia Avenue", new Coordinate(2, 43), 15);
		Node n9 = new Node("St. James Place", new Coordinate(-9, 68), 11);
		Node n10 = new Node("Tennesee Avenue", new Coordinate(0, 72), 6);
		Node n11 = new Node("New York Avenue", new Coordinate(11, 90), 3);
		Node n12 = new Node("Kentucky Avenue", new Coordinate(16, 105), 8);
		Node n13 = new Node("Indiana Avenue", new Coordinate(31, 96), 4);
		Node n14 = new Node("Illinois Avenue", new Coordinate(42, 111), 13);
		Node n15 = new Node("Atlantic Avenue", new Coordinate(67, 83), 2);
		Node n16 = new Node("Ventnor Avenue", new Coordinate(78, 99), 4);
		Node n17 = new Node("Marvin Gardens", new Coordinate(99, 101), 7);
		Node n18 = new Node("Baltic Avenue", new Coordinate(113, 87), 8);
		Node n19 = new Node("North Carolina Avenue", new Coordinate(100, 69),
				12);
		Node n20 = new Node("Pennsylvania Avenue", new Coordinate(84, 50), 4);
		Node n21 = new Node("Park Place", new Coordinate(96, 31), 7);
		Node n22 = new Node("Boardwalk", new Coordinate(102, 14), 16);
		Node r1 = new Node("Reading Railroad", new Coordinate(62, 30), -5);
		Node r2 = new Node("Pennsylvania Railroad", new Coordinate(33, 51), -5);
		Node r3 = new Node("B&O Railroad", new Coordinate(53, 72), -5);
		Node r4 = new Node("Short Line", new Coordinate(68, 42), -5);
